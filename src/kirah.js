function Kirah(){
    return(
        <div className="ki">
            <div>
                <img className="back" src="bri.png"></img>
            </div>
            <div className="top">
            ...
            I like flowers in spring, rain in summer, leaves in autumn, and snow in winter. I like to sleep early, 
            I like to get up late; I like to be alone, I like to be surrounded by people. 
            ...
            I like delicious food and comfortable shoes; I like good books and romantic movies. I like the land and the nature, 
            I like people. And, I like to laugh.
            </div>
        </div>
    )
}
export default Kirah;